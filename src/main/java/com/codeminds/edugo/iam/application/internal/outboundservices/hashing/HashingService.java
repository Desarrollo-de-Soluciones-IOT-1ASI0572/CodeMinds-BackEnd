package com.codeminds.edugo.iam.application.internal.outboundservices.hashing;
...
public interface HashingService {
     ...
     * @return boolean true if the raw password matches the encoded password, false
     *         otherwise
     */
